module TicTacToe
  ...
  describe SimpleComputer do
    ...
    before(:each) do
      ...
      @simple_computer = SimpleComputer.new('X', mock_console_ui)
    end

    it "returns the player's marker" do
      expect(@simple_computer.marker).to eq('X')
    end
    ...
    describe ".make_move" do
      context "the computer selects a move that is open" do
        it "randomly selects a move and returns a board object" do
          ...
          result = @simple_computer.make_move(initial_board)
      ...
      context "the computer selects a move that is not open" do
        it "selects another move" do
          ...
          result_board = @simple_computer.make_move(initial_board)
